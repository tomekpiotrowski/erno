...
// Defined alongside the collector types so the sparkline has one point shape
// whether its data came from Prometheus or from the collector's own series.
export type { PromPoint } from './api';
import type { PromPoint } from './api';
